...
import pandas as pd
from utils import build_iterator, config, train
...
if 'F5_year' in desired_bands:
    time_labels = data['F5_year'].nunique()
else:
    time_labels = 0
...
model = Net(config, time_labels, inputs_dim=inputs_dim)
